...
const IconNext = ({skipToNext}) => {




    return (
        <svg  onClick={() => {skipToNext()}} className={s.icon_next} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 330 330">
